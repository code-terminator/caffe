...
def run_pat():
    ...
    basename += "-" + date + "-"
    fname_train = basedir + "/data/train_data.txt"
    fname_test = basedir + "/data/test_data.txt"
    fcpickle_train = basedir + '/data/train_data.cpickle'
    fcpickle_test = basedir + '/data/test_data.cpickle'
    input_dim = 300
    output_dim = 1
    ...
    stepsize = 5000000
    maxiter = 5000000
    weight_file = basedir + "/pat1m-sgd-13-03-2016-0.01/_iter_10000000.caffemodel"
